"""Arrow-schema helpers for the explain worker.

Keeps column-comment plumbing in one place so every function exposes consistent,
documented schemas to DuckDB. Mirrors the sibling vgi-sklearn helper.
"""
